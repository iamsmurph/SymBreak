...
flag = "100epochs_RandomSplit_Binary_Dipole_3478"
writer = SummaryWriter('modeling/runs/ffnn/binaryRandomVer1exp3478/' + flag)
...
class NeuralNet(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.l1 = nn.Linear(input_size, 64, bias=True)
        self.l2 = nn.Linear(64, 32, bias=True)
        self.l3 = nn.Linear(32, output_size, bias=True)
...
# Hyper-parameters 
hparam = {"input_size": 121, "output_size": 1, "num_epochs": 500, 
            "batch_size": 100, "lr": 5*1e-5, "lrDecay": 0.995, "weight_decay": 1e-6,
